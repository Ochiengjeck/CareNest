...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .statement-box { background: #fffbeb; border: 1px solid #fcd34d; border-radius: 3px; padding: 10px 12px; font-size: 9.5px; line-height: 1.7; color: #78350f; font-style: italic; }
...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="doc-title">Refusal of Medical Treatment</div>
    </div>
    ...
    <div class="resident-strip">
        <table><tr>
            ...
            <td><span class="label">Refusal Date: </span><span class="value">{{ $record->refusal_date->format('m/d/Y') }}</span></td>
        </tr></table>
    </div>

    <div class="section">
        <div class="section-title">Refusal Details</div>
        <div class="section-body">
            <div class="field-label" style="margin-bottom:4px;">Illness / Injury Description</div>
            @if($record->illness_description)
                <p class="text-block">{{ $record->illness_description }}</p>
            @else
                <span class="no-val">No description recorded.</span>
            @endif
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="section-body">
            <div class="statement-box">
                I have been offered the opportunity to have medical care at the doctors office, hospital, urgent care for the above illness/injury. I feel as though I do not require medical care at this time. However, should I feel the need to have medical care, I will immediately report this to a staff.
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <div class="section-title">Staff Signature</div>
        <div class="section-body">
    ...
    <div class="footer">
        <span>{{ $facility }} &mdash; Confidential Medical Record</span>
