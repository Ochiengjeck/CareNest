...
class extends Component {
    ...
    public function mount(): void
    {
        ...
        // Default to AI generation if available
        if (app(MentorshipLessonService::class)->isAiAvailable()) {
    ...
    public function startSession(): void
    {
        ...
        if ($this->saveLessonToLibrary && !empty($this->lessonContent) && !$this->selectedLessonId) {
                    ...
                    <div class="space-y-4">
                        @if($this->availableLessons->isNotEmpty())
                            ...
                            @if($lessonContent && $selectedLessonId)
                                <div class="p-4 rounded-lg bg-zinc-50 dark:bg-zinc-800 prose dark:prose-invert max-w-none max-h-96 overflow-y-auto">
                                    {!! nl2br(e($lessonContent)) !!}
                                </div>
                            @endif
                        @else
