...
{
    /**
     * Rules for creating/scheduling a new therapy session.
     * Does NOT include documentation fields (interventions, progress_notes, client_plan).
     */
    ...
    /**
     * Rules for editing a therapy session (includes all fields).
     */
    protected function therapySessionEditRules(): array
    {
        return [
            'therapist_id' => ['required', 'exists:users,id'],
            'resident_id' => ['required', 'exists:residents,id'],
    ...
    /**
     * Rules for documenting a completed session.
     */
